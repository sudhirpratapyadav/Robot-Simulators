...
RESET_JOINT_VALUES = [0.0, -1.1898947954177856, 1.9831578731536865, 0.0, 0.0, 0.0]+[0.45, -0.45, -0.45, 0.45]
...
robotUrdfPath = os.path.join(currentdir, "./ur5_rg2/urdf/ur5_rg2_2.urdf")
